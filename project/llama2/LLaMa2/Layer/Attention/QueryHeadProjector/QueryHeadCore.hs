module LLaMa2.Layer.Attention.QueryHeadProjector.QueryHeadCore
  ( queryHeadCore, QueryHeadCoreOut(..), QHeadDebugInfo(..)
  ) where
...
import qualified LLaMa2.Layer.Attention.QueryHeadProjector.QueryOutputTransactionController as OutputTransactionController
import qualified LLaMa2.Layer.Attention.QueryHeadProjector.QueryOutputAccumulator as OutputAccumulator
import qualified LLaMa2.Layer.Attention.QueryHeadProjector.QueryInputTransactionController as InputTransactionController
import qualified LLaMa2.Layer.Attention.QueryHeadProjector.QueryRowComputeUnit as RowComputeUnit
import qualified LLaMa2.Layer.Attention.QueryHeadProjector.QueryRowScheduler as RowScheduler
import qualified LLaMa2.Layer.Attention.QueryHeadProjector.QueryWeightFetchUnit as WeightFetchUnit

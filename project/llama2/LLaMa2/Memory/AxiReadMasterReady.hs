module LLaMa2.Memory.AxiReadMasterReady
  ( axiBurstReadMasterReady ) where
...
axiBurstReadMasterReady :: HiddenClockResetEnable dom
  => AxiSlaveIn dom
...
axiBurstReadMasterReady slaveIn baseAddr burstLen startRead sinkReady =

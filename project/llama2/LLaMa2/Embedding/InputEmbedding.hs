module LLaMa2.Embedding.InputEmbedding
 ( inputEmbedding, inputEmbeddingTop
) where
...
{-# ANN inputEmbeddingTop
  (Synthesize
    { t_name   = "input_embedding"
    , t_inputs =
        [ PortName "clk"
        , PortName "rst"
        , PortName "en"
...
inputEmbeddingTop = exposeClockResetEnable inputEmbedding
